...
FROM (VALUES
  ...
  ('saobracaj', 'Odron zatrpao deo lokalnog puta',                            'Posle obilnih kiša zemlja i kamenje su se obrušili na put. Prohodna je samo jedna traka, bez ikakve signalizacije.',                 'Viteževo',     'Put ka Viteževu',     44.28320, 21.25050, 'solved', 20, 16),
